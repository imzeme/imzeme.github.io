/*
    ...
    My version (chomiczok.pl): 
    - https://github.com/imzeme/chomiczok.pl
...
const VIDEOS = [
  ...
  'media/videos/szanty.mp4',
  'media/videos/rizzmas.mp4',
  'media/videos/tomscottpl.mp4',
  'media/videos/v09044g40000cgr968jc77u1t2krb89g.mov',
  'media/videos/kaczuszka.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/chomikcigarette.png',
  'media/images/chomikpisanie.png',
  'media/images/placz.jpg',
  'media/images/chomis.png',
  'media/images/chomikuj.jpg',
  'media/images/chomikujvaper.jpg',
  'media/images/chomikryjec.png', 
]

const PHRASES = [
  'hello my name is chomiczok, lol',
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'replaceme@thezeme.ovh',
          displayName: 'Chomiczok zeme'
        },
